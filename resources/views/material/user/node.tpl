													...
													<div class="tile tile-collapse">
														<div data-toggle="tile" data-target="#heading{$node_order->$prefix}">
															...
															<div class="tile-inner">
																<div class="text-overflow">{$prefix} | <font color="#ff9000"><i class="icon icon-lg">person</i></font> <strong><b><font color="#474747">{$node_alive[$prefix]}</font></b></strong> <!--| <i class="icon icon-lg">build</i> {$node_method[$prefix]}--> | <font color="#ff9000"><i class="icon icon-lg">equalizer</i></font> <font color="#aaaaaa">{if isset($node_bandwidth[$prefix])==true}{$node_bandwidth[$prefix]}{else}N/A{/if}</font></div>
															</div>
														</div>
