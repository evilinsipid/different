											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade active in" id="all_ssr_windows">
														...
														{if $user->class==0}
															<p><h4><span class="icon icon-lg">start</span> 尊敬的{$user->user_name}，您还未购买任何套餐。请先到<a href="/user/code">充值界面</a>充值金额，再到<a href="/user/shop">商店界面</a>购买套餐，否则将无法使用。</p></h4>
														{/if}
														...
														<p> <span class="icon icon-lg text-white">looks_5</span> 服务器订阅<span class="icon icon-lg text-white">play_arrow</span>更新SSR服务器订阅(不通过代理)</p>
													...
													<div class="tab-pane fade" id="all_ssr_ios">
														{if $user->class==0}
															<p><h4><span class="icon icon-lg">start</span> 尊敬的{$user->user_name}，您还未购买任何套餐。请先到<a href="/user/code">充值界面</a>充值金额，再到<a href="/user/shop">商店界面</a>购买套餐，否则将无法使用。</p></h4>
														{/if}
                                                        <p><span class="icon icon-lg text-white">looks_one</span> 切换<code>App Store</code>账号-ID:<code>shz7348@icloud.com</code> 密码<code>Qq#123456</code>注意特殊符号与大小写。（千万不要试图登陆iCloud，会上传您的照片与通讯录到这个账户上）</p>
